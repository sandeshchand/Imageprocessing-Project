...
class ImageProcessingTask(object):
    __metaclass__ = ABCMeta

    @abstractmethod
    def grayImageTask(self):
        pass

    @ abstractmethod
    def blurrfilterTask(self):
        pass

    @ abstractmethod
    def thresholdFilterTask(self):
        pass

    @ abstractmethod
    def contouringTask(self):
        pass

class Microscopic_Image(ImageProcessingTask):

        def _init_(self, image,index,processFlag):
            ...
            super(Microscopic_Image,self)._init_()
        ...
        def contouringTask(self):
            ...
            output = open(
                ...
                'a')
            output.write("[{}],[{}],[{}],[{}],[{}],[{}],[{}]".format("Total defect","Area of defects ", "mean_value ", "median_value",
            ...
            plt.show()
#Microscopic_Image(image,index,processFlag)
